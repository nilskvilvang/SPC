...
```{r echo = FALSE, message = FALSE, warning=FALSE, fig.cap = "Fra Nolan & Provost, 1990, s.3, figur 1"}
...
nolan_provost <- data.frame(Områder = c("","Fokus", "Mål", "Grunnlag", "Metoder"),
                            Variasjon1 = c("Som indikator på god eller dårlig ytelse", "Resultat av prosessen (produkt, tjeneste)", "Klassifisere resultat som akseptabelt eller ikke", "Hva kunden ønsker eller trenger", "Metoder	Spesifikasjoner, budsjetter, prognoser, numeriske mål, verktøy for å måle ytelse"),
                            Variasjon2 = c("Som resultat av normal eller unormal variasjon", "Årsaker til variasjon i prosessen", "Gi grunnlag for endring av prosess", "Hva prosessen faktisk gir", "Kontrolldiagram"))

nolan_provost <- flextable(nolan_provost)

set_table_properties(nolan_provost, width = 1, layout = "autofit")
```
